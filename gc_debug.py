...
# from https://github.com/python/cpython/blob/main/Lib/tracemalloc.py
# because VenusOS has _tracemalloc, but no tracemalloc.
...
# see https://github.com/python/cpython/blob/3.9/Modules/clinic/_tracemalloc.c.h
# for signatures. (hope not changed from 3.8)
import _tracemalloc
...
def get_object_traceback(obj):
    ...
    """
    frames = _tracemalloc._get_object_traceback(obj)
